...
var objOkTab = "";
layui.use(["jquery","element", "layer",  "okTab", "okLayer", "okContextMenu", "okHoliday"], function () {
	...
	function noticeFun() {
		...
		layer.open({
			type: 0, title: "南昌索歌服饰", btn: "收到", btnAlign: 'c', content: okHoliday.getContent(),
			yes: function (index) {
				if (srcWidth > 800) {
	...
	$(".layui-footer button.donate").click(function () {
		layer.tab({
			...
			tab: [{
				title: "微信",
				content: "<img src='/static/ok/images/wx.jpg'  width='330' height='440' style='margin: 0 auto; display: block;'>"
			}]
		});
	});
