        ...
        warehouseList: function () {
            ...
            layui.use(['form', 'table','tableMerge'], function () {
                ...
                ea.table.render({
                    ...
                    cols: [
                        [
                            {field: '全国排名', width: 80, title: '全国排名',search:false,rowspan: 2,fixed:'left'},
                            {field: '货号', width: 110, title: '货号',search:false,rowspan: 2,fixed:'left'},
                            {field: '风格', width: 80, title: '风格',search:'select',selectList:Style,rowspan: 2,fixed:'left'},
                            {field: '一级分类', width: 110, title: '一级分类',fieldAlias:'cate',search:'select',selectList:CategoryName1,rowspan: 2,fixed:'left'},
                            {field: '二级分类', width: 110, title: '二级分类',fieldAlias:'cate2',search:'select',selectList:CategoryName2,rowspan: 2,fixed:'left'},
                            {field: '领型', width: 110, title: '领型',fieldAlias:'collar',search:'select',selectList:Collar,rowspan: 2,fixed:'left'},
