            ...
            layui.use(['form', 'table','tableMerge'], function () {
                ...
                ea.table.render({
                    ...
                    cols: [
                        ...
                        {field: '图片', width: 140, title: '图片', search: false, templet: ea.table.image,imageHeight:30,merge: true},
                ...
                ea.table.render({
                    ...
                    cols: [
                        [
                            ...
                            {field: '图片', width: 140, title: '图片', search: false,rowspan: 2, templet: ea.table.image,imageHeight:30,merge: true},
