        ...
        index: function () {
            ...
            ea.request.get({
                ...
                var cols = [
                    ...
                    {field: '_31', width: 50, title: '31/40/50/XL',search: false},
                    {field: '_32', width: 50, title: '32/41/52/2XL',search: false},
                    {field: '_33', width: 50, title: '33/42/54/3XL',search: false},
                    {field: '_34', width: 50, title: '34/43/56/4XL',search: false},
                    {field: '_35', width: 50, title: '35/44/58/5XL',search: false},
