define(["jquery", "easy-admin2"], function ($, ea) {
    var init = {
        ...
        update_url: 'system.puhuoonegoodsrule/update',
        add_url: 'system.puhuoonegoodsrule/add',
        delete_url: 'system.puhuoonegoodsrule/delete',
        list_index: '/admin/system.puhuoonegoodsrule/index'
    };
    ...
    var Controller = {
        ...
        index: function () {
            url = ea.url('/system.puhuoonegoodsrule/getWeatherField');
            ea.request.get({
                url:url,
                data:{}
            },function (res) {
