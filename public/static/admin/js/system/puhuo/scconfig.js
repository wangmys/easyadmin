define(["jquery", "easy-admin", "vue"], function ($, ea, Vue) {
    ...
    var Controller = {
       ...
       //满足率评分标准
       fill_rate:function (){
            var fill_rate_head = $("#fill_rate_head").val();
            var fill_rate_head = JSON.parse(fill_rate_head);
            // console.log(fill_rate_head);
            var html = '';
            var that = this;
            fill_rate_head.forEach(function (i,value) {
                    html += '<td class="field_'+ value +'_'+ i +'"><input type="text" name="' + i + '[]" lay-verify="required" value="" placeholder="请输入" class="layui-input"></td>'
            })
            // $('.add_fill_rate').on('click', function(){
            //     var element = $([
            //         '<tr>',
            //             ,html,
            //             '<td class="handler">',
            ...
            // });
                ...
                // 获取渲染后端渲染的数据,重新绑定事件
                $.each($('.puhuo_fill_rate-select'), function (key, element) {

                    $(element).find('.get_fill_rate').on('click', function(){
        ...
        //动销率评分标准
        dongxiao_rate:function (){

            var that = this;

            // 获取渲染后端渲染的数据,重新绑定事件
            $.each($('.puhuo_dongxiao_rate-select'), function (key, element) {

                $(element).find('.get_dongxiao_rate').on('click', function(){
