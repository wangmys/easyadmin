...
class SpWwBudongxiaoDetail extends TimeModel
{
    ...
    protected static $fields = 'd.商品负责人,d.省份,d.季节归集,d.二级时间分类,d.风格,d.上市时间,d.经营模式,d.店铺名称,d.店铺库存数量,d.云仓,d.货号,d.大类,d.中类,d.小类,d.累销量,d.月销量,d.五天销量,d.十天销量,d.十五天销量,d.二十天销量
