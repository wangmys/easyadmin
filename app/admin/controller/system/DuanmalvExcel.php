...
class DuanmalvExcel extends AdminController
{
    ...
    public function excel_sk() {
        if (request()->isAjax()) {
            ...
            return Excel::exportData($select, $header, '秋_单店断码明细_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // 下载单店断码明细  sk
    public function excel_sk_winter() {
        if (request()->isAjax()) {
            $input = input();
            foreach ($input as $key => $val) {
                if (empty($val)) {
            ...
            return Excel::exportData($select, $header, '冬_单店断码明细_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // 下载单店断码明细  sk
    public function excel_sk_summer() {
        if (request()->isAjax()) {
            $input = input();
            foreach ($input as $key => $val) {
                if (empty($val)) {
            ...
            return Excel::exportData($select, $header, '夏_单店断码明细_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // 下载单店断码明细  sk
    public function excel_sk_spring() {
        if (request()->isAjax()) {
            $input = input();
            foreach ($input as $key => $val) {
                if (empty($val)) {
            ...
            return Excel::exportData($select, $header, '春_单店断码明细_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    public function excel_table6() {
        if (request()->isAjax()) {
            ...
            return Excel::exportData($select, $header, '秋_单店品类断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // table6 单店品类断码情况  冬
    public function excel_table6_winter() {
        if (request()->isAjax()) {
            // 筛选条件
            $input = input();
            ...
            return Excel::exportData($select, $header, '冬_单店品类断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    public function excel_table6_summer() {
        if (request()->isAjax()) {
            // 筛选条件
            $input = input();
            ...
            return Excel::exportData($select, $header, '夏_单店品类断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    public function excel_table6_spring() {
        if (request()->isAjax()) {
            // 筛选条件
            $input = input();
            ...
            return Excel::exportData($select, $header, '春_单店品类断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    public function excel_table4() {
        ...
        $count = $this->db_easyA->query($sql2);
            ...
            return Excel::exportData($select, $header, '秋_单店单款断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // table4
    public function excel_table4_winter() {
        if (request()->isAjax()) {
            // 筛选条件
            $input = input();
        ...
        $count = $this->db_easyA->query($sql2);
            ...
            return Excel::exportData($select, $header, '冬_单店单款断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // table4
    public function excel_table4_summer() {
        if (request()->isAjax()) {
            // 筛选条件
            $input = input();
        ...
        $count = $this->db_easyA->query($sql2);
            ...
            return Excel::exportData($select, $header, '夏_单店单款断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
    ...
    // table4
    public function excel_table4_spring() {
        if (request()->isAjax()) {
            // 筛选条件
            $input = input();
        ...
        $count = $this->db_easyA->query($sql2);
            ...
            return Excel::exportData($select, $header, '春_单店单款断码情况_' . session('admin.name') . '_' . date('Ymd') . '_' . time() , 'xlsx');
