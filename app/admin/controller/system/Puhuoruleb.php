 ...
 * @ControllerAnnotation(title="铺货规则参数B （单款指定铺货规则）")
 */
class Puhuoruleb extends AdminController
{
    protected $sort = [
        'sort' => 'desc',
        'id'   => 'desc',
    ...
    public function __construct(App $app)
    {
        ...
        $this->model = new SpLypPuhuoRuleBModel;
    }
    ...
    public function update() {
        ...
        $goods_info_list = SpLypPuhuoWaitGoodsModel::where([])->column('StyleCategoryName,StyleCategoryName1,CategoryName1,CategoryName2');//column('风格 as StyleCategoryName,一级风格 as StyleCategoryName1,一级分类 as CategoryName1,二级分类 as CategoryName2');
