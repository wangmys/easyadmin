...
class Customorstocksale7 extends AdminController
{
    ...
    public function getField() {
        return json([
            ...
            '前五天库存数量','前四天库存数量','前三天库存数量','前二天库存数量','前一天库存数量','前七天库存成本','前六天库存成本','前五天库存成本','前四天库存成本','前三天库存成本','前二天库存成本','前一天库存成本','前七天成本金额','前六天成本金额','前五天成本金额','前四天成本金额',
            '前三天成本金额','前二天成本金额','前一天成本金额']
        ]);
    }
