...
class Ajax extends ShopController
{
    ...
    {
        $cacheData = Cache::get('initShop_' . session('shop.id'));
        if (!empty($cacheData)) {
            return json($cacheData);
        }
        $menuService = new MenuService(session('shop.id'));
        $data = [
            'logoInfo' => [
        ...
        Cache::tag('initShop')->set('initShop_' . session('shop.id'), $data);
        return json($data);
    }
