    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        if ($all_customers) {
            foreach ($all_customers as $v_customer) {
                ...
                //预计在店数量
                $instore_new_ztpx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '=', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '正统皮鞋']])->sum('预计库存Quantity');
                $instore_new_xxx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '=', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '休闲鞋']])->sum('预计库存Quantity');
                $instore_new_ydx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '=', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '运动鞋']])->sum('预计库存Quantity');
                $instore_new_lx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '=', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '凉鞋']])->sum('预计库存Quantity');
                $instore_new_xj = $instore_new_ztpx + $instore_new_xxx + $instore_new_ydx + $instore_new_lx;
                $instore_old_ztpx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '<>', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '正统皮鞋']])->sum('预计库存Quantity');
                $instore_old_xxx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '<>', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '休闲鞋']])->sum('预计库存Quantity');
                $instore_old_ydx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '<>', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '运动鞋']])->sum('预计库存Quantity');
                $instore_old_lx = CustomerKcSkByWangweiModel::where([['`当前零售价`'.'/'.'`零售价`', '>=', config('skc.shoe_proportion')],   ['CustomerName', '=', $v_customer['CustomerName']], ['TimeCategoryName1', '<>', config('skc.shoe_year')], ['当前零售价', '>', $shoe_price], ['预计库存Quantity', '>', config('skc.shoe_expect_stock')], ['一级分类', '=', '鞋履'], ['二级分类', '=', '凉鞋']])->sum('预计库存Quantity');
