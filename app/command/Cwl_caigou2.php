...
class Cwl_caigou2 extends Command
{
    // 接收筛选参数
    public $params = [];
    // 数据库
    ...
    protected function configure() {
        ...
        // 指令配置
        $this->setName('Cwl_caigou2')
            ->setDescription('the Cwl_caigou2 command');
    }
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $select = $this->db_easyA->table('cwl_swoole_test')->where(['id' => 2])->update(['num' => time()]);
        // if ($select) {
