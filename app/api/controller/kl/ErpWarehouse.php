...
use think\Request;
use think\facade\Db;
use app\api\service\kl\WarehouseService;
use app\api\validate\WarehouseValidate;

class ErpWarehouse extends BaseController
{
    protected $request;
    protected $service;
    ...
    public function create() {
        ...
        try {
            validate(WarehouseValidate::class)->scene('create')->check($params);
    ...
    public function update() {
        ...
        try {
            validate(WarehouseValidate::class)->scene('update')->check($params);
        } catch (ValidateException $exception) {
            return json(['code'=>400, 'msg'=>$exception->getError(), 'data'=>[]]);
        }
    ...
    public function delete() {
        ...
        try {
            validate(WarehouseValidate::class)->scene('delete')->check($params);
        } catch (ValidateException $exception) {
            return json(['code'=>400, 'msg'=>$exception->getError(), 'data'=>[]]);
        }
