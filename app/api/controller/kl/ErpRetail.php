...
use app\api\validate\RetailValidate;
...
class ErpRetail extends BaseController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->service = new RetailService();
    }
    ...
    public function create() {
        ...
        try {
            validate(RetailValidate::class)->scene('create')->check($params);
    ...
    public function update() {
        ...
        try {
            validate(RetailValidate::class)->scene('update')->check($params);
        } catch (ValidateException $exception) {
            return json(['code'=>400, 'msg'=>$exception->getError(), 'data'=>[]]);
        }
    ...
    public function delete() {
        ...
        try {
            validate(RetailValidate::class)->scene('delete')->check($params);
        } catch (ValidateException $exception) {
            return json(['code'=>400, 'msg'=>$exception->getError(), 'data'=>[]]);
        }
