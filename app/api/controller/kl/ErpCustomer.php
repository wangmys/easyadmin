...
use think\Request;
use think\facade\Db;
use app\api\service\kl\CustomerService;
use app\api\validate\CustomerValidate;

class ErpCustomer extends BaseController
{
    protected $request;
    protected $service;
    ...
    public function update() {
        ...
        try {
            validate(CustomerValidate::class)->scene('update')->check($params);
        } catch (ValidateException $exception) {
            return json(['code'=>400, 'msg'=>$exception->getError(), 'data'=>[]]);
        }
    ...
    public function delete() {
        ...
        try {
            validate(CustomerValidate::class)->scene('delete')->check($params);
        } catch (ValidateException $exception) {
            return json(['code'=>400, 'msg'=>$exception->getError(), 'data'=>[]]);
        }
