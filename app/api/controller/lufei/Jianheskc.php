...
class Jianheskc extends BaseController
{
    ...
    //     $dsn="mysql:host=192.168.9.230:9030;dbname=sg_dw";
    //     try{
    //         //链接数据库
    //         $pdo=new PDO($dsn,"root","doris@2023");
    //         //执行sql语句
    //         $sql="select * from market_history_stock_week limit 10;";
    ...
    // 数据仓
    protected function doris(){
        $host     = '183.6.86.105:19030';
        $username = 'root';
        $password = 'doris@2023';
        $dbname   = 'sg_ods';
