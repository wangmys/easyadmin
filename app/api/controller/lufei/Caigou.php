    ...
    public function handle_1() {
        ...
        $sql_当天销量排名 = "
            ...
            where 
                m1.货号 = m2.货号
        ";
        $this->db_easyA->execute($sql_当天销量排名);        
        ...
        $sql_鞋履当天销量排名 = "
            ...
            (
                SELECT
                    ...
                    @大类 := a.大类 AS 大类 
                FROM
                    ( SELECT 货号,大类,中类,当天销量 FROM cwl_cgzdt_caigoushouhuo WHERE 大类 IN ( '鞋履' ) AND 当天销量 IS NOT NULL ) AS a,
            ...
            where 
                m1.货号 = m2.货号
        ";
        $this->db_easyA->query($sql_鞋履当天销量排名); 
