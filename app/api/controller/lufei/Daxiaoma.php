    ...
    public function handle_1() {
        $sql = "
            SELECT
                ...
                case when sum(`预计00/28/37/44/100/160/S`)>0 then sum(`预计00/28/37/44/100/160/S`) else null end as `预计SKC_00/28/37/44/100/160/S`,
                case when sum(`预计29/38/46/105/165/M`)>0  then sum(`预计29/38/46/105/165/M`) else null end as `预计SKC_29/38/46/105/165/M`,
                case when sum(`预计30/39/48/110/170/L`)>0  then sum(`预计30/39/48/110/170/L`) else null end as `预计SKC_30/39/48/110/170/L`,
                case when sum(`预计31/40/50/115/175/XL`)>0  then sum(`预计31/40/50/115/175/XL`) else null end as `预计SKC_31/40/50/115/175/XL`,
                case when sum(`预计32/41/52/120/180/2XL`)>0  then sum(`预计32/41/52/120/180/2XL`) else null end as `预计SKC_32/41/52/120/180/2XL`,
                case when sum(`预计33/42/54/125/185/3XL`)>0  then sum(`预计33/42/54/125/185/3XL`) else null end as `预计SKC_33/42/54/125/185/3XL`,
                case when sum(`预计34/43/56/190/4XL`)>0  then sum(`预计34/43/56/190/4XL`) else null end as `预计SKC_34/43/56/190/4XL`,
                case when sum(`预计35/44/58/195/5XL`)>0  then sum(`预计35/44/58/195/5XL`) else null end as `预计SKC_35/44/58/195/5XL`,
                case when sum(`预计36/6XL`)>0 then sum(`预计36/6XL`) else null end as `预计SKC_36/6XL`,
                case when sum(`预计38/7XL`)>0 then sum(`预计38/7XL`) else null end as `预计SKC_38/7XL`,
                case when sum(`预计_40`)>0 then sum(`预计_40`) else null end as `预计SKC_40`,
        ...
        $sql_云仓可用 = "
            ...
            left join (
                SELECT
                    仓库名称 as 云仓,
                    case
                        WHEN 二级时间分类 in ('初春','正春','春季') THEN '春季'
                        WHEN 二级时间分类 in ('初夏','盛夏','夏季') THEN '夏季'	
                        WHEN 二级时间分类 in ('初秋','深秋','秋季') THEN '秋季'
                        WHEN 二级时间分类 in ('初冬','深冬','冬季') THEN '冬季'
                    end as 季节归集,
                    一级分类,二级分类,风格,一级风格,
                    sum(`可用库存_00/28/37/44/100/160/S`) as `云仓可用00/28/37/44/100/160/S`,
                    sum(`可用库存_29/38/46/105/165/M`) as `云仓可用29/38/46/105/165/M`,
                    sum(`可用库存_30/39/48/110/170/L`) as `云仓可用30/39/48/110/170/L`,
                    sum(`可用库存_31/40/50/115/175/XL`) as `云仓可用31/40/50/115/175/XL`,
                    sum(`可用库存_32/41/52/120/180/2XL`) as `云仓可用32/41/52/120/180/2XL`,
                    sum(`可用库存_33/42/54/125/185/3XL`) as `云仓可用33/42/54/125/185/3XL`,
                    sum(`可用库存_34/43/56/190/4XL`) as `云仓可用34/43/56/190/4XL`,
                    sum(`可用库存_35/44/58/195/5XL`) as `云仓可用35/44/58/195/5XL`,
                    sum(`可用库存_36/6XL`) as `云仓可用36/6XL`,
                    sum(`可用库存_38/7XL`) as `云仓可用38/7XL`,
                    sum(`可用库存_40`) as `云仓可用_40`,
                    sum(`可用库存Quantity`) as `云仓可用数量`
                FROM
                    sp_ww_budongxiao_yuncangkeyong 
                WHERE 1 
                GROUP BY
                    仓库名称,季节归集,一级分类,二级分类,风格,一级风格
                Having 季节归集 is not null
            ) as t on  h.云仓 = t.云仓 and h.季节归集 = t.季节归集 and h.一级分类 = t.一级分类 and h.二级分类 = t.二级分类  and h.风格 = t.风格 and h.一级风格 = t.一级风格
            set
                h.`云仓可用00/28/37/44/100/160/S` = t.`云仓可用00/28/37/44/100/160/S`,
                h.`云仓可用29/38/46/105/165/M` = t.`云仓可用29/38/46/105/165/M`,
                h.`云仓可用30/39/48/110/170/L` = t.`云仓可用30/39/48/110/170/L`,
                h.`云仓可用31/40/50/115/175/XL` = t.`云仓可用31/40/50/115/175/XL`,
                h.`云仓可用32/41/52/120/180/2XL` = t.`云仓可用32/41/52/120/180/2XL`,
                h.`云仓可用33/42/54/125/185/3XL` = t.`云仓可用33/42/54/125/185/3XL`,
                h.`云仓可用34/43/56/190/4XL` = t.`云仓可用34/43/56/190/4XL`, 
                h.`云仓可用35/44/58/195/5XL` = t.`云仓可用35/44/58/195/5XL`,
                h.`云仓可用36/6XL` = t.`云仓可用36/6XL`,
                h.`云仓可用38/7XL` = t.`云仓可用38/7XL`,
                h.`云仓可用_40` = t.`云仓可用_40`,
                h.`云仓可用数量` = t.`云仓可用数量`
            where 
                h.一级分类 in ('内搭', '外套', '下装', '鞋履')
        ";
